...
namespace EmailPost
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //emailTO = "aizquierdo***REMOVED***;sandra.arias***REMOVED***;rlaines***REMOVED***;capa_postpago***REMOVED***;calidadpostpago***REMOVED***;lima.tlclaropostpago***REMOVED***;postpagoclarotc***REMOVED***;leslie.caceres***REMOVED***;***REMOVED***;amesta***REMOVED***";
            //emailCC = "reportes_cdg***REMOVED***;gmorales***REMOVED***;eduardo.vizcarra***REMOVED***;validadorescrosspostpago***REMOVED***";
            ...
            //emailTO = "vrea***REMOVED***;rlaines***REMOVED***;amesta***REMOVED***";
            //emailCC = "capa_hfctecnico***REMOVED***;capa_hfcadmin***REMOVED***;CalidadHFCTecnico***REMOVED***;CalidadHFCAdmin***REMOVED***;tl.hfctec***REMOVED***;tl.admin.clarohfc***REMOVED***;aseguramientodeprocesos***REMOVED***;***REMOVED***;juan.huilca***REMOVED***";
        ...
        static bool SendMail(string sSubject, string sMessage, int iPriority, string attach, string emailTo, string emailCC)
        {
            try
            {
                ...
                string sEmailUser = "***REMOVED***";
                string sEmailPass = "***REMOVED***";
                string sEmailSendTo = emailTo;
                string sEmailSendCC = emailCC;
                string sEmailSendFrom = "***REMOVED***";
                string sEmailSendFromName = "***REMOVED***";
